        ...
        public partial class Flow
        {
            ...
            public class StaveNote : StemmableNote
            {
                ...
                private void Init(StaveNoteStruct noteStruct)
                {
                    ...
                    this.renderOptions = new StaveNoteRenderOpts() { glyphFontScale = 35, strokePx = 3 };
                ...
                public void BuildNoteHeads()
                {
                    ...
                    if (stemDirection.Value == Vex.Flow.Stem.Down)
                    {
                        startI = keys.Count() - 1;
                        endI = -1;
                        stepI = -1;
                ...
                public void CalculateKeyProps()
                {
                    ...
                    for (int i = 0; i < this.keys.Count(); i++)
                    {
                        ...
                        NoteProps props = Vex.Flow.KeyProperties(key, this.clef);
                        if (props == null)
                        {
                    ...
                    List<NoteProps> keyProps = this.keyProps.ToList();
                    keyProps.Sort(
                        new Comparison<NoteProps>(
                            delegate(NoteProps a, NoteProps b) { return 1; }
                        ));
                ...
                /// <returns></returns>
                public ModifierStartXY GetModifierStartXY(Vex.Flow.Modifier.ModifierPosition position, int index)
                {
                    if (!this.preFormatted)
                    {
                    ...
                    double x = 0;
                    if (position == Vex.Flow.Modifier.ModifierPosition.LEFT)
                    {
                        // extra_left_px
                        x = -1 * 2;
                    }
                    else if (position == Vex.Flow.Modifier.ModifierPosition.RIGHT)
                    {
                        // extra_right_px
                        x = this.glyph.headWidth + this.xShift + 2;
                    }
                    else if (position == Vex.Flow.Modifier.ModifierPosition.BELOW || position == Vex.Flow.Modifier.ModifierPosition.ABOVE)
                    {
                ...
                /// <returns></returns>
                public StaveNote AddAccidental(int index, Modifier accidental)
                {
                ...
                /// <returns></returns>
                public StaveNote AddArticulation(int index, Modifier articulation)
                {
                ...
                /// <returns></returns>
                public StaveNote AddAnnotation(int index, Modifier annotation)
                {
                ...
                {
                    this.ExtraLeftPx = this.displaced && this.stemDirection == -1 ? this.glyph.headWidth : 0;
                    this.ExtraRightPx = this.displaced && this.stemDirection == -1 ? this.glyph.headWidth : 0;
                }
                /// <summary>
                ...
                public override void PreFormat()
                {
                    ...
                    if (this.glyph.flag && this.beam == null && this.stemDirection == 1)
                    {
                ...
                public NoteHeadBounds GetNoteHeadBounds()
                {
                    ...
                    return new NoteHeadBounds() {yTop=yTop.Value,yBottom=yBottom.Value,highestLine=highestLine,lowestLine=lowestLine };
                }
                /// <summary>
                ...
                public double GetNoteHeadEndX()
                {
                    ...
                    return xBegin + this.glyph.headWidth - (Vex.Flow.STEM_WIDTH / 2);
                }
                /// <summary>
